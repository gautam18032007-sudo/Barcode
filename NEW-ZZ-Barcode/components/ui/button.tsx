...
const buttonVariants = cva(
  // Base — adds smooth transition, active scale, and GPU-composited will-change
  ...
  "aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        ...
        outline:
          "border bg-background shadow-xs hover:bg-accent/60 hover:text-accent-foreground hover:border-slate-300 " +
